<%@ Page Title="" Language="C#" MasterPageFile="../Master/GiveCamp.master" AutoEventWireup="true" CodeFile="NonProfitFAQ.aspx.cs" Inherits="Default" %>
...
<p>
    See <a href="http://seattlegivecamp.org/FAQ/Location.aspx">location page</a>. Expect an email regarding details a day or two before the event.
</p>
<h2>
    On-site: Will I be fed?
</h2>
<p>
...
<p>
    ...
    non-profit organizations. This custom software could be a new website for the nonprofit organization, a small data-collection application to keep track of
    members, or a application for the Red Cross that automatically emails a blood donor three months after they’ve donated blood to remind them that they are
    now eligible to donate again. The only limitation is that the project should be scoped to be able to be completed in a weekend.
</p>
<h2>
...
<p>
    ...
    during and after the event to ensure that your development team is successful. If your organization is selected, the following requirements are made:
</p>
<ul type="disc">
    <li>
