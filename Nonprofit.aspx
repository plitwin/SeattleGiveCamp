...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
  ...
  <!--p>Seattle GiveCamp 2015 has not been planed yet.  To be put on our mailing list email</p--> 
        ...
        <ul>
            ...
            <li>Will the project greatly enhance the mission of the nonprofit?</li>
            <li>Does the project match the skill set of our volunteers?</li>
        </ul>
        <h3>My charity got selected. What now?</h3>
        <p>Congratulations! We fondly look forward to working with your organization. Here are a few things to think about that might be helpful when planning your project.</p>
        <ul>
